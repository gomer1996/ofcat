...
class ExportProductsQueue extends Resource
{
    /**
     ...
     * @var string
     */
    public static $model = \App\Models\ExportProductsQueue::class;
    ...
    {
        return [
            Text::make('')->default(fn () => 'Экспорт товаров'),
