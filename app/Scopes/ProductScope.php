...
class ProductScope implements Scope
{
    ...
    public function apply(Builder $builder, Model $model)
    {
        ...
        $userDiscount = 'ROUND((products.price + IF(products.ignore_tax = 1, 0, (products.price * (products.markup / 100))))  * (1 - IF(ucd.discount > 0,ucd.discount,'.$discount.') / 100), 2)';
        $categoryDiscount = 'ROUND((products.price + IF(products.ignore_tax = 1, 0, (products.price * (products.markup / 100)))) * (1 - categories.discount / 100), 2)';
